namespace GrandPrix2
{
    ...
    public  class RaceTower
    {
        ...
        {
            trackInfo = new TrackInfo(lapsNumber, trackLength);
        }
        ...
        public void RegisterDriver(List<string> commandArgs)
        {
            try
            {
                Tyre tyre = TyreFactory.PitForTyres(commandArgs.Skip(4).ToList());
        ...
        public void DriverBoxes(List<string> commandArgs)
        {
            ...
            {
                case "ChangeTyres":
                    Tyre newTyre = TyreFactory.PitForTyres(commandArgs.Skip(2).ToList());
